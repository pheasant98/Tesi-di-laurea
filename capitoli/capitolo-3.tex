...
\begin{trivlist}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.125]{queGrey.png}\hfill
		\includegraphics[scale=0.125]{queGreen.png}\hfill
		\includegraphics[scale=0.125]{queRed.png}
...
Nella Figura~\ref{fig:websocket} viene mostrato come avviene la creazione di una connessione tra l'applicazione mobile e Azzurra.io, i passi perciò sono:
\begin{enumerate}
