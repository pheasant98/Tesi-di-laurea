...
\section{Descrizione}
Come scritto precedentemente, dietro all'applicazione \emph{mobile} c'è tutta un'\g{architettura} di sistema che permette la comunicazione tra la piattaforma \gls{AWMS} e l'applicazione \emph{mobile} con Azzurra.
...
Durante l'esecuzione di una conversazione è molto probabile che Azzurra abbia bisogno di far visualizzare delle informazioni richieste dall'utente ad esempio il suo orario di lavoro, queste informazioni però non sono salvate ne nell'applicazione \emph{mobile} né in Azzurra.io ma nel \g{back-end}.
\begin{figure}[h]
	\begin{center}
