...
\begin{itemize}
	...
	\item La seconda parte è stata dedicata allo studio del funzionamento dell'\g{architettura} del sistema che permette l'esecuzione di Azzurra, in particolare il funzionamento dei metodi del motore conversazionale denominato Azzzura Flow Engine e in aggiunta, come esercitazione, è stato richiesta la creazione di alcuni \g{test e2e} per la parte \g{front-end} del sistema e per la \emph{dashboard} di \gls{AWMS};
	...
	\item Nella quinta parte, sulle basi dello studio fatto in precedenza, è stato previsto lo sviluppo di una test-suite di \g{test e2e}, con l'obiettivo di automatizzare i test qualora le funzionalità dell'applicazione \emph{mobile} funzionassero in modo corretto;
